...
<script type="text/javascript">
    $().ready(function() {
        ...
        $('textarea.tinymce').tinymce({
            ...
            document_base_url : "http://admin.biarq.com/img/paginas",

            // General options
            theme : "advanced",
            plugins : "autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,advlist,imagemanager,imagemanager",
        ...
        <td>
            ...
            <div id="content-table-inner">
                ...
                <div id="table-content">
                    <?= $this->form->create($pagina, array('method' => 'post', 'enctype' => 'multipart/form-data')); ?>

                    <?= $this->form->field('titulo', array('class' => "inp-form")); ?>
                    <?= $this->form->field('texto', array('type' => 'textarea', 'class' => 'tinymce')); ?>
                   
                    <?= $this->form->submit('Editar Pagina'); ?>
                    <?= $this->form->end(); ?>
